...
const [deleting, setDeleting] = useState(false);
  ...
  try {
    ...
    const setData = response.data && response.data.length > 0 ? response.data[0] : null;
...
const handleGenerateFlashcards = async () => {
  ...
  try {
    ...
    // Trigger the fetch function we fixed in the previous step
...
const handleReview = async (index) => {
  ...
  try {
    ...
    // Optional: toast.success("Flashcard reviewed!");
  } catch (error) {
...
const renderFlashcardContent = () => { // Added arrow function syntax
  if (loading) {
    return <Spinner />;
  }
  ...
  return ( 
    <div className="flex flex-col items-center space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-sm font-neutral-600">
