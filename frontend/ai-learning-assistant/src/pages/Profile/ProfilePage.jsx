...
<div className="bg-white border border-neutral-200 rounded-lg p-6">
  ...
  {/* Added 'space-y-4' to create vertical gaps between input groups */}
  <form onSubmit={handleChangePassword} className="space-y-4">
    ...
    {/* Added 'pt-2' for extra breathing room above the button */}
    <div className="flex justify-end pt-2">
      <Button type="submit" disabled={passwordLoading} className="bg-[#34967c] hover:bg-[#2a7a65]">
